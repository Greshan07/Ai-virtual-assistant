...
function SignIn() {
  ...
  return (
    ...
    >
      <form className='w-[90%] h-[600px] max-w-[500px] bg-[#00000062] backdrop-blur-xl shadow-lg shadow-black flex flex-col items-center justify-center gap-[20px] rounded-2xl border border-white/20 p-6' onSubmit={handleSignIn}>
   ...
   <div className="w-full h-[60px] border-2 border-white bg-transparent text-white rounded-full text-[18px] relative" >
      ...
      { err.length >0 && <p className='text-red-500 text-sm'>*{err}</p> }
        ...
        <p className='text-white cursor-pointer' onClick={() => navigate('/signup')}>Want to Create New Account? <span className='text-blue-400 underline'>Sign Up</span></p>
